...
public class UseStream_03_intstream
	...
	private static void useConvertion()
		...
		// sans mapToInt
			...
			// version 1 : lambda
				...
				IntFunction<Integer[]> tabGenerator = null;// TODO
		...
		// version3 : avec mapToInt : more easy
			{
			// Indication : simple!
			int[] tab = null;// TODO
	...
	private static void useListCopy()
		...
		// v2 copy profonde
			...
			List<Integer> listSource = new LinkedList<Integer>();
			listSource.add(1);
			listSource.add(2);
			listSource.add(3);
			listSource.add(4);
			...
			//  Indication: collect
				{
				//  Version1 : lambda
				List<Integer> listCopyDeep1 = null;//TODO

				//  Version2 : reference methode
				List<Integer> listCopyDeep2 = null;//TODO

				listSource.add(999);// ne modifie pas listCopyDeep

				System.out.println(listCopyDeep1);
				System.out.println(listCopyDeep2);
				}
			}
		}
